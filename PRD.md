...
- [x] View-specific data: Hook data loaders to each view (Daily due; Week/Month relevant tasks)
...
- [x] Parent dropdown: Select any category as parent
...
- [x] Iconography: Add soft-edged icons for categories/tasks
- [x] Micro-interactions: Completion animation (e.g. subtle bounce/confetti)
...
- [x] Accessibility pass: Buttons/checkboxes labeled; basic a11y audit
